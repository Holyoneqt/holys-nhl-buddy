...
function createStandingTable(teamRecords, details) {
    ...
    teamRecords.forEach(t => {
        ...
        if (t.wildCardRank === '0') { teamName.style.background = 'rgba(178, 219, 191, 0.5)'; }
        else if (t.wildCardRank === '1') { teamName.style.background = 'rgba(255, 255, 88, 0.5)'; }
        else if (t.wildCardRank === '2') { teamName.style.background = 'rgba(255, 22, 84, 0.5)'; }
